...
<head>
<meta charset="utf-8">
<title>Sensor de ultrasonido HC-SR04</title>
...
<!--CDN FONTAWESOME-->
 ...
 <link href="zoom.min.css" rel="stylesheet">
 <link href="spin.min.css" rel="stylesheet">
</head>
...
<!--Comienza nosotros-->
    ...
    <div>
        <b>Sensor de ultrasonido HC-SR04</b>
     </div>
    <table class="table">
     ...
     <img src="imagen/hc-sr04.jpg" width="200" height="200" class="thumbnail" alt="Sensor Hc-sr04" alt="Sensor ultrasonido hc-sr04">
     <br>
    <div class="row">

<div class="col-md-4">
            <div class="mag">
     <img  data-toggle="magnify" src="imagen/hc-sr04-2.png" width="100" height="100" alt="sensor ultrasonido fase1"></div></div> 
     <div class="col-md-4">
     <div class="mag">
     <img  data-toggle="magnify" src="imagen/hc-sr04-3.png" width="100" height="100" alt="sensor ultrasonido fase2"></div></div>
     <div class="col-md-4">
     <div class="mag">
     <img data-toggle="magnify" src="imagen/hc-sr04.png" height="100" width="100" alt="sensor ultrasonido fase3"></div></div>
    ...
    <!--Ojo aqui pura magia de php-->
    <p class="text-info">Precio de lista: 3423</p>  
	<p class="text-success">Promoci&oacute;n: 35%</p>
	<p class="text-muted">	CÓDIGO:SUHC0004-J6-CB42</p>
	<p class="text-danger">Disponibilidad:455</p>
    
    <form action="" method="post">
    <small>Cantidad:</small><br>
    <input id="input-number-mod" class="mod" type="number" value="1" />
    <br>
    <input type="button" class="btn-info" value="Agregar al carro">
    <br>
    <br>
    <input type="button" class="btn-success" value="Ir a pagar" >
    </form>
     </td> 
	 </tr> 
    </table>
    <div>
    <h3 class="text-success">Descripci&oacute;n</h3><br>
    El HC-SR04 es un sensor ultrasónico, este utiliza el sonar para determinar la distancia a un objeto. Ofrece una precisión excelente y lecturas estables. Su funcionamiento no se ve afectado por la luz solar o materiales negros, aunque materiales acusticamente suaves como la tela pueden ser difíciles de detectar.
    </div>
    <div>
    <h3 class="text-info">Especificaciones</h3><br>
    &bull;Fuente de alimentacion :5V DC<br>
	&bull;Angulo efectivo: &lt;15°<br>
	&bull;Distancia efectiva de medicion : 2cm – 500 cm/1" - 16ft<br>
	&bull;Resolucion : 0.3 cm<br><br>
    <a href="#">
    <img src="busquedaFacturas/Imagenes/index.jpg" width="50" height="50"></a>
    </div>
    </div>
